...
public class FormController implements Initializable {
    ...
    private void actions() {
        ...
        btnAgregar.setOnAction(event -> {
            System.out.println("Procedemos a agregar un usuario");
            Alert dialogo = null;
            if (editNombre.getText().isEmpty()
                    || editPassword.getText().isEmpty()
            ...
            dialogo.show();
                ...
                String pass = editPassword.getText();
        ...
        checkLista.selectedProperty().addListener((observableValue, aBoolean, t1) -> {
            if (t1){
