...
public class Gestor {
    ...
    public void exportarXML(){
        ...
        try {
            ...
            System.out.println("Error en los atributos del XML");
        }catch (Exception e){
    ...
    public void importarXML(){
        try {
            ...
            Libreria libreria = (Libreria) unmarshaller
                    .unmarshal(new File("src/main/java/ficheros/libreria.xml"));
    ...
    public void getPoductoById(int id){
        try {
            URL url = new URL(urlBase+"/"+id);
            ObjectMapper mapper = new ObjectMapper();
            Producto producto =mapper.readValue(url, Producto.class);
